...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener,
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mIncrementButton = (NumberPickerButton) findViewById(R.id.number_picker_button_increment);
		mIncrementButton.setOnClickListener(this);
		mIncrementButton.setOnLongClickListener(this);
		mIncrementButton.setNumberPicker(this);
		mDecrementButton = (NumberPickerButton) findViewById(R.id.number_picker_button_decrement);
		mDecrementButton.setOnClickListener(this);
		mDecrementButton.setOnLongClickListener(this);
		mDecrementButton.setNumberPicker(this);

		mText = (TextView) findViewById(R.id.number_picker_input);
		mText.setOnFocusChangeListener(this);
		mText.setFilters(new InputFilter[] { mInputFilter });
		// mText.setRawInputType(TYPE_CLASS_NUMBER);
		// InputType.TYPE_CLASS_NUMBER

		mSlideUpOutAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, -100);
		mSlideUpOutAnimation.setDuration(200);
		mSlideUpInAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 100,
				Animation.RELATIVE_TO_SELF, 0);
		mSlideUpInAnimation.setDuration(200);
		mSlideDownOutAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 100);
		mSlideDownOutAnimation.setDuration(200);
		mSlideDownInAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0,
				Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, -100,
				Animation.RELATIVE_TO_SELF, 0);
	...
	public void onClick(View v) {
		...
		if (R.id.number_picker_button_increment == v.getId()) {
			changeCurrent(mCurrent + 1, mSlideUpInAnimation, mSlideUpOutAnimation);
		} else if (R.id.number_picker_button_decrement == v.getId()) {
			changeCurrent(mCurrent - 1, mSlideDownInAnimation, mSlideDownOutAnimation);
		}
	}
	...
	private class NumberRangeKeyListener extends NumberKeyListener {
		...
		public int getInputType() {
			return TYPE_CLASS_NUMBER; // InputType.TYPE_CLASS_NUMBER
		}
